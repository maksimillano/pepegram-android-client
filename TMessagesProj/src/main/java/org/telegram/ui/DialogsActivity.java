...
//            }
    ...
    public void updateStatus(TLRPC.User user, boolean animated) {
        ...
        if (emojiStatusId != null) {
            ...
            long pepeEmojiToolbarId = getMessagesController().pepeEmojiToolbarId;
            statusDrawable.set(pepeEmojiToolbarId, animated);
        ...
        if (onlySelect) {
            ...
            if (folderId != 0) {
                ...
                if (BuildVars.DEBUG_VERSION) {
                    actionBar.setTitle(LocaleController.getStringLocal(R.string.AppNameBeta), statusDrawable);
                } else {
                    actionBar.setTitle(LocaleController.getStringLocal(R.string.AppName), statusDrawable);
                }
