...
public class LauncherIconController {
    ...
    public enum LauncherIcon {
        DEFAULT("DefaultIcon", getBackgroundDefault(), R.mipmap.ic_launcher_foreground, R.string.AppIconDefault),
        ...
        private static int getBackgroundDefault() {
            return ApplicationLoader.isStandaloneBuild() ? R.mipmap.ic_launcher_background_stand : R.mipmap.ic_launcher_background;
        }
